...
sys.path.insert(0, os.path.abspath(os.path.join(__location__, "../src/DatabaseScraper")))
sys.path.insert(0, os.path.abspath(os.path.join(__location__, "../src/DataVisualization")))
...
htmlhelp_basename = "PokemonIdentifier-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "PokemonIdentifier Documentation", "Willi-Bon", "manual")
]
